...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.qnyp.tittalert.js')
	...
	f = os.path.join(cwd,'Classes','ComQnypTittalertModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.qnyp.tittalert.js']
